// "HPP Lattice Gas Cellular Automaton on a square lattice"
class LGCA {
	constructor(L, rho, img) {
		this.d = 4;
		this.L = int(L);
		this.rho = rho;
		this.img = img;
		...
		this.V = int(L * L);
		//this.N = int(rho*this.V*this.d); // d particles can fit in each grid point
		
		// velocity field 0/1:
		//   is there a particle moving along direction 1,2,3,4?
		//   1=(1,0) 2=(0,1) 3=(-1,0) 4=(0,-1)
		this.vel = createEmptyArray(this.V, this.d);
		// density field 0,1,2,3,4:
